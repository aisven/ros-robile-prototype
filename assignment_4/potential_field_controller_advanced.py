...
class PotentialFieldController(Node):
    def __init__(self):
        ...
        self.declare_parameter("conic_a", False, ParameterDescriptor(description="conic instead of quadratic attractive potential field"))
        self.declare_parameter("k_a", 0.7, ParameterDescriptor(description="attraction gain"))
        self.declare_parameter("k_r", 1.2, ParameterDescriptor(description="repulsion gain"))
        self.declare_parameter("rho_0", 1.20, ParameterDescriptor(description="repulsion threshold (m)"))
        ...
        self.declare_parameter("pos_tolerance", 0.07, ParameterDescriptor(description="position tolerance to consider goal reached (m)"))
        self.declare_parameter("ang_tolerance", 0.15, ParameterDescriptor(description="angular tolerance to consider orientation reached (rad)"))
