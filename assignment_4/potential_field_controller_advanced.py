...
class PotentialFieldController(Node):
    def __init__(self):
        ...
        self.declare_parameter("k_a", 0.5, ParameterDescriptor(description="attraction gain"))
        self.declare_parameter("k_r", 1.0, ParameterDescriptor(description="repulsion gain"))
        ...
        self.declare_parameter("v_max_linear", 0.5, ParameterDescriptor(description="max linear speed (m/s)"))
        self.declare_parameter("v_max_angular", 0.785399, ParameterDescriptor(description="max angular speed (rad/s)"))
        self.declare_parameter("k_ang", 1.0, ParameterDescriptor(description="angular gain when orienting at goal"))
